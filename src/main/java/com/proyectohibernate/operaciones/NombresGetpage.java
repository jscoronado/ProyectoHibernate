 ...
 * @author rafa
 */
public class NombresGetpage implements GenericOperation {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<Nombres> oNombress = oNombresDAO.getPage(rpp, page, alFilter, hmOrder);
            data = new Gson().toJson(oNombress);
            data = "{\"list\":" + data + "}";
            return data;
        } catch (Exception e) {
